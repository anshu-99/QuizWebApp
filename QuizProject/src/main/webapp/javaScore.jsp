...
<body>
    ...
    <%
        ...
        String[] correctAnswers = { "32 bits", "2", "1value", "int[] arr = new int[5];", "Hello53", "String",
                "Inheritance", " Hiding implementation details and showing only essential features of an object",
                "Inheritance", "final" };
